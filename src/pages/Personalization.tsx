...
export default function Personalization() {
  ...
  async function handleBuilderSave(file: File) {
    ...
    try {
      ...
      setMessage('Overlay gespeichert – du findest es jetzt direkt unter der Vorschau in der Galerie.');
    } catch (err) {
        ...
        <div className="space-y-6 xl:col-span-2">
          <GlassCard className="h-fit p-6">
            ...
            <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_220px]">
              ...
              <div className="rounded-2xl bg-white/30 p-4 xl:max-h-[30rem] xl:overflow-y-auto">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
                    {assets.map((asset) => {
                      ...
                      return (
                        <div
                          key={asset.id}
                          className="rounded-2xl border border-white/40 bg-white/70 p-3 shadow-sm"
                        >
          ...
          <GlassCard className="p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-xl border border-dashed border-white/40 bg-white/20 px-3 py-3 text-sm text-slate-500">
                Neue Uploads und Builder-Overlays erscheinen direkt links unter der Vorschau in der Galerie.
              </div>
            </div>
          </GlassCard>
